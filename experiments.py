...
def run_experiment(config: Dict, name: str, n_episodes: int = 1000, 
...
def plot_comparison(histories: List[Dict], title: str, save_path: str):
    """
    ...
    ax = axes[1]
    for history in histories:
        ax.plot(history['eval_episodes'], history['eval_rewards'], 
                marker='o', label=history['name'], linewidth=2)
    ax.set_xlabel('Episode')
...
def experiment_learning_rates():
    ...
    plot_comparison(histories, 
                   ...
                   "images/experiment_learning_rate.png")
...
def experiment_network_architectures():
    ...
    plot_comparison(histories,
                   ...
                   "images/experiment_architecture.png")
...
def experiment_batch_sizes():
    ...
    plot_comparison(histories,
                   ...
                   "images/experiment_batch_size.png")
